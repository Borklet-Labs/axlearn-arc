...
for i in ${groups[@]}; do
    ...
    pytest -v  \
        ...
        -n auto -m "not (gs_login or tpu or high_cpu or fp64 or for_8_devices)" --durations=100 --dist worksteal --timeout=30 \
    ...
    JAX_ENABLE_X64=1 pytest -v \
        ...
        -n auto -m "fp64" --durations=100 --dist worksteal --timeout=30 \
        $(tr '\n' ' ' < split_pytest_files_${i})
    ...
    pytest -v \
        ...
        -n auto -m "for_8_devices" --durations=100 --dist worksteal --timeout=30 \
        $(tr '\n' ' ' < split_pytest_files_${i}) 
