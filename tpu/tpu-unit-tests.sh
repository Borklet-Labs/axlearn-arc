...
gsutil -h "x-goog-meta-test-type:unit-tests" -h "x-goog-meta-processor:tpu" \
   ...
   -m cp /home/runner/_work/csv_results/tpu_tests.csv ${GCS_PREFIX}/results/unit-tests-tpu-${GITHUB_HASH}-${JAX_VER}-${GH_RUN_ID}-${TIMESTAMP}.csv
